...
Welcome to `pymeteos` contributor's guide.
...
If you experience bugs or general issues with `pymeteos`, please have a look
...
You can help improve `pymeteos` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`pymeteos` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `pymeteos`'s files. While this mechanism can
...
```
conda create -n pymeteos python=3 six virtualenv pytest pytest-cov
conda activate pymeteos
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/pymeteos.git
   cd pymeteos
   ```
...
5. Install [pre-commit]:
   ...
   `pymeteos` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/pymeteos
[issue tracker]: https://github.com/<USERNAME>/pymeteos/issues
